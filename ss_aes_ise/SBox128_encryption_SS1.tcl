# 
# Project automation script for AES128_encryption_SS1 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source AES128_encryption_SS1.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "../hdl_src/UART.v"
   xfile add "./CW308T_S6LX9_Example.ucf"

   # Set the Top Module as well...
   project set top "CW308T_S6LX9_Example"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/ouldeitn/ise/spartan6_AES/AES128_encryption_SS1/xst" -process "Synthesize - XST"
   ...
   project set "RAM Style" "Distributed" -process "Synthesize - XST"
   ...
   project set "Output File Name" "CW308T_S6LX9_Example" -process "Generate IBIS Model"
